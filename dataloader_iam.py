...
class DataLoaderIAM:
    ...
    This is the primary dataset used for the training.
    """
    ...
    def __init__(self,
        ...
        for line in f:
            # ignore the first as it is a comment line
            ...
            if line_split[0] in bad_samples_reference:
                print('Ignoring known broken image:', file_name) #to remove the bad references.
                continue
